...
console.log(TRANSCEND_SUPPORTED_TRANSLATIONS);
...
/** Mapping of Language to AWS Translation */
export const LANGUAGE_TRANSLATION_MAP = {
  ...
  [LOCALE_KEY.ZuZa]: AWS_SUPPORTED_TRANSLATIONS.English, // TODO: this translation is just english?
...
const CONSENT_MANAGER_UNSUPPORTED_LANGUAGES = [
  'Ar',
  'Fr',
  'Es',
  'De',
...
/** Union of Consent Manager unsupported language keys */
export type ConsentManagerUnsupportedTranslationKey =
  typeof CONSENT_MANAGER_UNSUPPORTED_LANGUAGES[number];
/** Union of Consent Manager unsupported language enum values */
export type ConsentManagerUnsupportedTranslationValue =
  typeof LOCALE_KEY[ConsentManagerUnsupportedTranslationKey];

/** Union of Consent Manager supported language keys */
export type ConsentManagerSupportedTranslationKey = Exclude<
  LocaleKey,
  ConsentManagerUnsupportedTranslationKey
>;
/** Union of Consent Manager supported language enum values */
...
export const CONSENT_MANAGER_SUPPORTED_LOCALES = Object.fromEntries(
  Object.entries(LOCALE_KEY).filter(
    ([key]) => !(key in CONSENT_MANAGER_UNSUPPORTED_LANGUAGES),
  ),
